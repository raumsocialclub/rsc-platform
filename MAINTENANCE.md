...
## 6. 콘텐츠·법무 (5분)
- [Claude] 약관 3종이 아직 자리 문구(`placeholder` 스위치)인지. 개인정보처리방침의 위탁 업체·보유 기간이 실제(위탁사 추가·삭제, 광고 도구 도입)와 아직 맞는지
- [Claude] pg_cron `purge-expired-logs` 가 매일 돌아 로그인 보안 기록 30일·접속 기록 1년 초과분을 지우는지
