...
export const SETTINGS_DOCS: DocDef[] = [
  ...
  },
  {
    ...
    fields: [b("emailEnabled", "이메일 발송 켜기"), t("fromName", "발신 이름"), t("fromEmail", "발신 주소", "Resend 에서 인증한 도메인의 주소")],
    defaults: { emailEnabled: true, fromName: "RAUM SOCIAL CLUB", fromEmail: "onboarding@resend.dev" },
  },
  {
    id: "settings.payment",
    page: "settings",
